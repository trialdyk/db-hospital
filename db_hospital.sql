...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Nov 2023 pada 02.46
...
CREATE TABLE `doctors` (
  ...
  `spesialist` enum('jantung','paru-paru','tenggorokan','gigi','kulit') NOT NULL,
...
(5, '2023_11_24_012415_create_hospitals_table', 1),
(6, '2023_11_24_012430_create_doctors_table', 1),
(7, '2023_11_24_012521_create_patients_table', 1);
...
CREATE TABLE `patients` (
  ...
  `rms` char(255) NOT NULL,
  `krs` char(255) NOT NULL,
  `billing_number` char(255) NOT NULL,
  `rm_number` char(255) NOT NULL,
  `administration_price` int(11) NOT NULL,
